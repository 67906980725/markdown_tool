#!/usr/bin/env python
# eg: python ./html2md.py https://www.zhihu.com/question/359865930/answer/2511151291
"""html2text: Turn HTML into equivalent Markdown-structured text. forked from aaronsw/html2text"""
__version__ = "3.200.3"
__author__ = "Aaron Swartz (me@aaronsw.com)"
__copyright__ = "(C) 2004-2008 Aaron Swartz. GNU GPL 3."
__contributors__ = ["Martin 'Joey' Schulze", "Ricardo Reyes", "Kevin Jay North"]

f_name="html2markdown.md"
...
class HTML2Text(HTMLParser.HTMLParser):
    ...
    def handle_tag(self, tag, attrs, start):
        ...
        if tag in ['p', 'div']:
            if self.google_doc:
                if start and google_has_height(tag_style):
                    ...
                    self.soft_br()
            if tag == "div" and self.astack: # 兼容知,乎<a><dir></dia></a>的情况
                self.p_p = 0
            else:
                self.p()
        ...
        if tag == "img" and start and not self.ignore_images:
            ...
            #             data-actualsrc="..." >
            #         </div>
            if has_key(attrs, 'src') and not has_key(attrs, 'data-actualsrc'):
